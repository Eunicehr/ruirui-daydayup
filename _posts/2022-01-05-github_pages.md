...
layout: post
title: github pages
subheading: 搭建一个个人的博客
author: cute-ruirui
categories: web
tags: github pages web blog
---
...
按照下面的格式进行替换，Authorization后粘贴token
...
- 选主题
  ...
  在http://jekyllthemes.org/中选定主题http://jekyllthemes.org/themes/jekyll-theme-yat/并安装
...
```yaml
title: guanguang
email: 2223925337@qq.com
author: ruirui-daydayup

baseurl: "/ruirui-daydayup/" # the subpath of your site, e.g. /blog
url: "https://eunicehr.github.io/" # the base hostname & protocol for your site, e.g. http://example.com
